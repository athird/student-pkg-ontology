...
# The Person (FOAF)
ex:student123 a foaf:Person ;
    foaf:firstName "Jane" ;
    foaf:lastName "Doe" ;
    foaf:name "Jane Doe" ;
    
    # Connection to Academic Education
    schema:memberOf ex:universityABC ;
    schema:educationalEnrollment ex:enrolment1 .

# The University
ex:universityABC a schema:CollegeOrUniversity ;
    foaf:name "Example University" .

# The Course/Enrolment Context
ex:enrolment1 a schema:EducationalOccupationalProgram ;
    schema:courseName "Computer Science" ;
    schema:offersCourse ex:courseCS101 .

# Specific Course Details
ex:courseCS101 a schema:Course ;
